...
const DEFAULT_MAP = "maps/adv_1_digital_forest.png";
...
// SPRITE_WALK_RUN_FRAME_MS = 300; // walk/run animation speed.
const SPRITE_WALK_RUN_FRAME_MS = 300;
const DIALOGUE_BUBBLE_DURATION = 6000;
